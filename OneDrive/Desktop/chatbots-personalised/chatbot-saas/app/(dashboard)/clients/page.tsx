  ...
  if (clients.length === 0) {
    return (
      <div className="mx-auto flex min-h-[70vh] max-w-4xl items-center justify-center">
        <div className="w-full rounded-[2rem] border border-slate-200 bg-white px-8 py-12 text-center shadow-xl shadow-slate-200/60">
          ...
          <Link
            href="/clients/new"
            className="mt-8 inline-flex h-12 items-center justify-center gap-2 rounded-2xl bg-slate-950 px-6 text-sm font-semibold text-white shadow-lg shadow-slate-950/15 transition hover:bg-slate-800"
          >
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <Link
          href="/clients/new"
          className="inline-flex h-12 items-center justify-center gap-2 rounded-2xl bg-slate-950 px-5 text-sm font-semibold text-white shadow-lg shadow-slate-950/15 transition hover:bg-slate-800"
        >
          <Plus className="h-4 w-4" />
          New Client
        </Link>
        ...
        {clients.map((client) => {
          ...
          return (
            <Link
              ...
              className="rounded-[1.5rem] border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-md"
            >
      ...
      <div className="hidden overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white shadow-sm md:block">
        <div className="border-b border-slate-200 bg-slate-50/80 px-6 py-4">
          <div className="grid grid-cols-[minmax(0,2.2fr)_1fr_110px_140px_160px] gap-4 text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">
            <span>Client</span>
            <span>Activity</span>
            <span>Status</span>
            <span>Created</span>
        ...
        <div className="divide-y divide-slate-100">
          {clients.map((client) => {
            ...
            return (
              <div
                key={client.id}
                className="grid grid-cols-[minmax(0,2.2fr)_1fr_110px_140px_160px] items-center gap-4 px-6 py-5 transition hover:bg-slate-50/80"
              >
                <div className="min-w-0">
